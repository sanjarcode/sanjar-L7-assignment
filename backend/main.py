...
@app.post("/movies/", response_model=schemas.Movie, tags=["Movies"])
...
@app.get("/actors/{actor_id}", response_model=schemas.Actor, tags=["Actors"])
...
@app.get("/directors/{director_id}", response_model=schemas.Director, tags=["Directors"])
